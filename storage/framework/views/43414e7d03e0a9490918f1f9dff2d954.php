                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                ...
                                                                                <?php else: ?>
                                                                                    <?php if($book->status === 'pending' || $book->status === 'rejected'): ?>
                                                                                        <li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" id="genre" name="genre" required>
                                            ...
                                            <option value="Science Fiction" <?php echo e(old('genre') == 'Science Fiction' ? 'selected' : ''); ?>>Science Fiction</option>
                                            ...
                                            <option value="Other" <?php echo e(old('genre') == 'Other' ? 'selected' : ''); ?>>Other</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <select class="form-select" id="edit_genre_<?php echo e($book->id); ?>" name="genre" required>
                                            <option value="">Select Genre</option>
                                            ...
                                            <option value="Romance" <?php echo e($book->genre == 'Romance' ? 'selected' : ''); ?>>Romance</option>
                                            <option value="Mystery" <?php echo e($book->genre == 'Mystery' ? 'selected' : ''); ?>>Mystery</option>
                                            <option value="Thriller" <?php echo e($book->genre == 'Thriller' ? 'selected' : ''); ?>>Thriller</option>
                                            <option value="Science Fiction" <?php echo e($book->genre == 'Science Fiction' ? 'selected' : ''); ?>>Science Fiction</option>
                                            <option value="Fantasy" <?php echo e($book->genre == 'Fantasy' ? 'selected' : ''); ?>>Fantasy</option>
                                            <option value="Biography" <?php echo e($book->genre == 'Biography' ? 'selected' : ''); ?>>Biography</option>
                                            <option value="Self-Help" <?php echo e($book->genre == 'Self-Help' ? 'selected' : ''); ?>>Self-Help</option>
                                            <option value="Business" <?php echo e($book->genre == 'Business' ? 'selected' : ''); ?>>Business</option>
                                            <option value="Other" <?php echo e($book->genre == 'Other' ? 'selected' : ''); ?>>Other</option>
                                        </select>
                                        <?php $__errorArgs = ['genre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <span class="badge badge-sm 
                                                        <?php switch($book->status):
                                                            case ('pending'): ?> badge-danger <?php break; ?>
                                                            <?php case ('accepted'): ?> badge-success <?php break; ?>
                                                            <?php case ('stocked'): ?> badge-info <?php break; ?>
                                                            <?php case ('rejected'): ?> badge-danger <?php break; ?>
                                                        <?php endswitch; ?>
                                                    "><?php echo e(ucfirst($book->status)); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
