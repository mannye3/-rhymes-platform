                                ...
                                <div class="card-tools">
                                    <div class="form-inline flex-nowrap gx-3">
                                        <form method="GET" action="<?php echo e(route('admin.books.index')); ?>" class="d-flex gap-2">
                                            <div class="form-wrap w-150px">
                                                <select name="status" class="form-select form-select-sm">
                                                    ...
                                                    <option value="accepted" <?php echo e(request('status') === 'accepted' ? 'selected' : ''); ?>>Published</option>
                                        ...
                                        <div class="btn-group ms-2">
                                            <a href="<?php echo e(route('admin.books.logs')); ?>" class="btn btn-sm btn-outline-secondary">
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                <?php if($book->trashed()): ?>
                                                                    <li><a href="#" onclick="restoreBook(<?php echo e($book->id); ?>); return false;"><em class="icon ni ni-reload"></em><span>Restore</span></a></li>
                                                                    <li><a href="#" onclick="forceDeleteBook(<?php echo e($book->id); ?>); return false;"><em class="icon ni ni-trash-fill"></em><span>Permanently Delete</span></a></li>
                                                                <?php else: ?>
                                                                    <?php if($book->status === 'pending'): ?>
                                                                        <li><a href="#" onclick="reviewBook(<?php echo e($book->id); ?>, 'accepted'); return false;"><em class="icon ni ni-check"></em><span>Approve</span></a></li>
                                                                        <li><a href="#" onclick="reviewBook(<?php echo e($book->id); ?>, 'rejected'); return false;"><em class="icon ni ni-cross"></em><span>Reject</span></a></li>
                                                                        <li><a href="#" onclick="reviewBook(<?php echo e($book->id); ?>, 'stocked'); return false;"><em class="icon ni ni-package"></em><span>Stock</span></a></li>
                                                                    <?php else: ?>
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <li class="divider"></li>
                                                                    <li><a href="#" class="text-danger" onclick="deleteBook(<?php echo e($book->id); ?>)"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                                <?php endif; ?>
                                                            </ul>
                                                        </div>
                                                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="reviewForm-<?php echo e($book->id); ?>" class="review-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-control-wrap">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="accept-<?php echo e($book->id); ?>" value="accepted" 
                                       <?php echo e($book->status === 'accepted' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="accept-<?php echo e($book->id); ?>">Accept</label>
                            </div>
                            <div class="form-check form-check-inline">
                    ...
                    <div class="form-group mb-3" id="revBookIdGroup-<?php echo e($book->id); ?>" style="<?php echo e($book->status !== 'accepted' ? 'display: none;' : ''); ?>">
            ...
            <div class="modal-footer bg-light">
                ...
                <button type="button" class="btn btn-primary" onclick="submitReview(<?php echo e($book->id); ?>)">Submit Review</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer bg-light">
                ...
                <?php if($book->status === 'pending'): ?>
                <button type="button" class="btn btn-primary" onclick="reviewBook(<?php echo e($book->id); ?>, 'accepted')">Approve</button>
                <button type="button" class="btn btn-danger" onclick="reviewBook(<?php echo e($book->id); ?>, 'rejected')">Reject</button>
                <button type="button" class="btn btn-info" onclick="reviewBook(<?php echo e($book->id); ?>, 'stocked')">Stock</button>
                <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        toggleRevBookIdField(<?php echo e($book->id); ?>);
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
});
