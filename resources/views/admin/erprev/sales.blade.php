            ...
            <div class="nk-block">
                <div class="card card-bordered card-full">
                    <div class="card-inner">
                        <form method="GET" action="{{ route('admin.erprev.sales') }}" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('admin.erprev.sales') }}" class="btn btn-light"><em class="icon ni ni-reload"></em><span>Reset</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach($salesData as $sale)
                                            <tr>
                                                ...
                                                <td>{!! $sale['CurrencySymbol'] ?? '&#x20A6;' !!}{{ number_format(((float)($sale['SellingPrice'] ?? 0)) * ((float)($sale['UnitsInStock'] ?? 0)), 2) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
