            ...
            <div class="nk-block">
                <div class="card card-bordered card-full">
                    <div class="card-inner">
                        <form method="GET" action="{{ route('admin.erprev.inventory') }}" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="warehouse_id" name="warehouse_id" value="{{ $filters['warehouse_id'] ?? '' }}" placeholder="Warehouse ID">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('admin.erprev.inventory') }}" class="btn btn-light"><em class="icon ni ni-reload"></em><span>Reset</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
